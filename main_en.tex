...
\begin{tabular}{|l|c|c|c|}
\hline
\textbf{Layer} & \textbf{Stage Type} & \textbf{Time (s)} & \textbf{\% of Total} \\
\hline
Layer 1 & Feature Extraction ($5\times5$) & 0.01690 & 3.5 \\
Layer 2 & Shrinking ($1\times1$) & 0.05865 & 12.1 \\
Layer 3 & Non-linear Mapping ($3\times3$) & 0.02323 & 4.8 \\
Layer 4 & Non-linear Mapping ($3\times3$) & 0.01942 & 4.0 \\
Layer 5 & Non-linear Mapping ($3\times3$) & 0.01543 & 3.2 \\
Layer 6 & Non-linear Mapping ($3\times3$) & 0.02056 & 4.2 \\
Layer 7 & Expanding ($1\times1$) & 0.12865 & 26.5 \\
Layer 8 & Deconvolution ($9\times9$) & 0.21721 & 44.7 \\
\hline
